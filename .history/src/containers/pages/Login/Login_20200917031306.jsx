...
const Login = () => {
  ...
  const isLogin = async (data) => {
    setSubmit(true);
    const loginData = {email: data.emailInput, password: data.passwordInput};
    console.log(data);
    const res = await axios.post("https://ancient-spire-87228.herokuapp.com/api/operator/login", JSON.parse(loginData));
