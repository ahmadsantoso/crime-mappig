  ...
  return (
    <div className="container">
      ...
      <div className="dropdown">
        ...
        {/* <select> */}
          <select defaultValue="Laporan">Semua Laporan</select>
          <select value="valid">Valid</select>
          <select value="notvalid">Tidak Valid</select>
          <select value="onprocess">Sudah di Proses</select>
          <select value="notprocess">Belum di Proses</select>
        {/* </select> */}
        </FormControl>
      </div>
